...
with c1:
    st.markdown(
        ...
        <div class="metric-card">
            ...
            <div class="metric-value" style="font-size:16px;">{latest_name}</div>
...
with c2:
    st.markdown(
        ...
        <div class="metric-card">
            ...
            <div class="metric-value" style="font-size:16px;">{file_modified or "—"}</div>
...
with c3:
    st.markdown(
        ...
        <div class="metric-card">
            ...
            <div class="metric-value" style="font-size:16px;">{last_processed}</div>
